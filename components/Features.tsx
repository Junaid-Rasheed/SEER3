...
export default function Features() {
  return (
    <div className="relative px-5 md:px-[115px]">
      ...
      <ul
        className="flex flex-col md:flex-row md:justify-between gap-[70px] mt-10 md:mt-16 mb-[100px] md:mb-[200px] text-white">
        {DATA.map((data) => (
          <li
      ...
      <div
        className="bg-black mb-[100px] md:mb-[200px] min-h-[112px] p-4 md:py-8 md:px-10 md:px-[55px] flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <CustomLink className="w-full md:w-auto" href="/list-your-startup">
